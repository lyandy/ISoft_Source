...
namespace ISoft
{
    ...
    public delegate void StartVirusScanHandle();
    public partial class UdiskMonitor : FormEx
    {
        public StartVirusScanHandle StartVirusScan;
        byte[] t;
        ...
        private void start_Speak()
        {
            ...
            spv.Speak("警告！！警告！！可移动磁盘正面临威胁！！", SpeechLib.SpeechVoiceSpeakFlags.SVSFDefault);
        }
        ...
        //private void UdiskMonitor_MouseDown(object sender, MouseEventArgs e)
        //{
        //    ReleaseCapture();
        ...
        private void UdiskMonitor_Load(object sender, EventArgs e)
        {
